...
# --- 1. FUNZIONE DATABASE CON AUTO-POPOLAMENTO ---
def init_db():
    # check_same_thread=False è necessario per SQLite su Streamlit
...
txt = {
    "Italiano": {"titolo": "Catalogo Beads", "cerca": "Cerca nella Collezione", "cam": "Inquadra Bead"},
    "English": {"titolo": "Beads Catalog", "cerca": "Search Collection", "cam": "Scan Bead"}
}[lang]

st.title(f"💎 {txt['titolo']}")

# --- 3. FOTOCAMERA ---
foto = st.camera_input(txt['cam'])
if foto:
...
search = st.text_input("SKU o Nome", placeholder="Es: TAGBE...")
