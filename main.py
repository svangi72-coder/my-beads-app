...
def init_db():
    ...
    beads_master = [
        ...
        ('Trollbeads', 'TGLBE-10425', 'canto_balena.jpg', 'Canto della Balena', 'Whale\'s Song', "La voce misteriosa dell'oceano che risuona nelle profondità.", "The mysterious voice of the ocean resonating in the deep."),
